...
(:action attend-morning-lecture
	; WRITE HERE THE CODE FOR THIS ACTION
	:parameters (?x ?y ?z ?w )
	:precondition (and (IS-STUDENT ?x) (IS-TEACHER ?y) (PERSON ?x) (PERSON ?y) (BUILDING ?z) (LECTURE ?w) (IS-LECTURE-AT ?w ?z) (is-person-at ?x ?z) (is-person-at ?y ?z) (IS-MORNING ?w) (teaches-lecture ?y ?w) (not (had-lunch ?x))  )
...
(:action attend-afternoon-lecture
	; WRITE HERE THE CODE FOR THIS ACTION
	:parameters (?x ?y ?z ?w)
	:precondition (and (PERSON ?x) (PERSON ?y) (IS-STUDENT ?x) (IS-TEACHER ?y) (BUILDING ?z) (LECTURE ?w) (IS-LECTURE-AT ?w ?z) (is-person-at ?x ?z) (IS-AFTERNOON ?w) (teaches-lecture ?y ?w) (had-lunch ?x)  )
	:effect (attended-lecture ?x ?w)
)
